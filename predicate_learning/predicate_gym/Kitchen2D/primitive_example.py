# Author: Zi Wang
import predicate_learning.predicate_gym.Kitchen2D.kitchen2d.kitchen_stuff as ks
from predicate_learning.predicate_gym.Kitchen2D.kitchen2d.kitchen_stuff import Kitchen2D
from predicate_learning.predicate_gym.Kitchen2D.kitchen2d.gripper import Gripper
import numpy as np
import time
import predicate_learning.predicate_gym.Kitchen2D.active_learners.helper as helper
SETTING = {
    'do_gui': False,
    'sink_w': 10.,
    'sink_h': 5.,
...
def main():
    ...
    # Scoop
    kitchen.gen_liquid_in_cup(large_cup, 500, 'sugar')
